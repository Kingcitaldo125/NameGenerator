...
"Barron","Barry","Bart","Benny","Bill","Blake","Brandon","Brian","Bryan","Brad","Brennan","Brent","Brett","Bob","Bobby",
"Caleb","Carl","Casey","Charles","Chad","Chandler","Chester","Chris","Chuck","Chuckie","Charlie","Craig","Clark","Clyde","Coby","Cole","Cory","Corey","Cody","Curt","Curtis",
...
"Garry","Garrett","Greg","Geoff","George","Gerald",
...
"Quinn","Quincy",
"Randy","Ray","Rhys","Rob","Robert","Robby","Robbie","Roger","Ronald","Ron","Ren","Rick","Richard","Ricky","Rickey","Rudy","Ryan",
"Scott","Sean","Seth","Simon","Stan","Steve","Stephen","Steven","Stevie",
"Taylor","Thomas","Timmy","Tim","Timmothy","Tommy","Travis","Trevor","Trey","Tony","Tom","Tyler",
"Vince","Vinny",
"William","Will","Willy","Willie","Winston",
"Xavier",
"Zach","Zachary","Zack","Zackary"]

ffNames = ["Amy","Ashley","Ashlee","Allison","Abigail","Ally","Abby","Alexandra","Anastasia","Ann","Anna","Annie","April","Asha",
"Barbara","Beth","Brandy","Brandi","Britt","Brittany","Bridget","Brooke",
"Carissa","Carley","Carla","Carli","Catherine","Cathy","Claire","Courtney",
"Darcy","Darla","Deb","Debra","Donna","Drew",
"Elizabeth","Ellyse","Elly","Emily","Emma","Erica","Erin",
"Francine","Fredricka",
"Gemma","Gina",
"India","Ivanka",
"Jane","Jasmine","Jacqueline","Jackie","Janet","Jan","Jen","Jenna","Jennifer","Jes","Jess","Jessica","Jessie",
"Katherine","Kathleen","Katrina","Kelcy","Kelly","Kelsey","Kristen",
"Laura","Lauren","Lisa","Liz","Lizzie","Lori","Lucy",
"Marianne","MaryAnn","Maryn","Mary","Melissa","Mel","Melanie","Melody","Mia","Morgan",
"Nancy","Nicole","November",
"Patrica","Pat","Patty","Polly",
"Quinn",
"Rain","Raven","Rhys","Roberta","Ruth",
"Sara","Sarah","Sean","Shanna","Shannon","Sharon","Stephanie","Susan","Suzy","Syd","Sydney",
"Tara","Taryn","Taylor","Theresa","Tina",
"Valerie","Veronica"]
...
"Carpenter","Carter","Carver","Clark","Crawford","Collins","Cook","Cole","Coorey","Culberson","Culver",
"Dalton","Davis","Day","Devers","Dole","Donaldson","Donovan","Duffy","Dunn","Dykstra",
"Edwards","Evans","Evers",
"Finch","Fry","Fuller",
"Gant","Gardner","George","Grant","Granderson","Gray","Greene","Green",
